...
export default function Navbar({ profileSrc, name, surname, number, onBurgerClick }: NavbarProps) {
    return (
        <Box display="flex" justifyContent="space-between" alignItems="center" padding="10px">
            ...
            <Box display="flex" alignItems="center">
                <Box marginRight="10px" display="flex" flexDirection="column">
                    ...
                    <Box display="flex" flexDirection="row" alignSelf="flex-end" alignItems="center">
